				...
				<div class="widget-summary-col">
					...
					<div class="summary-footer">
						...
						<div id="opc_repetir_act">
							<p class="subt_accion panel-subtitle">Repeat activity</p>
						...
						<div id="repetir_actividad">
							<form id="frm_repetiract">
								<div class="form-group">
									<h4 class="col-md-12 control-label tit_fin_act">Repeat activity</h4>
								</div>
								<div class="form-group">
									<label class="col-md-5 control-label" for="textareaDefault">Frequence</label>
									<div class="col-md-7">
										<select id="freq_rep_act" class="form-control valid" name="frecuencia_rep" required>
											...
											<option value="Fechas">By dates</option>
										</select>
									</div>
								</div>
								<hr>
								...
								<div class="form-group opc_repeticiones" id="num_repeticiones_semanal">
									<label class="col-md-5 control-label" for="textareaDefault">Number of repetitions</label>
									<div class="col-md-7">
										<div class="btn-group">
								...
								<div class="form-group opc_repeticiones" id="fechas_repeticiones">
									<div class="col-md-5" style="padding-bottom: 16px;">
										<label class="control-label" for="textareaDefault">Add dates to repeat activity</label>
								...
								<div id="proyeccion_fechas" class="form-group opc_repeticiones">
									<div class="col-md-5"> Future dates:</div>
