						...
						<div class="col-md-8 col-sm-6 col-xs-12">
							<section id="arbol_opa" class="panel">
								<header class="panel-heading">
									<h2 class="panel-title">Purposes - Activities</h2>
									<p class="panel-subtitle">
										<i class="fa fa-puzzle-piece" aria-hidden="true"></i> Objects | 
										<i class="fa fa-crosshairs" aria-hidden="true"></i> Purposes |
										<i class="fa fa-thumb-tack" aria-hidden="true"></i> Activities
									</p>
								</header>
