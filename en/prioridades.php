					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							<section class="panel panel-success">
								<header class="panel-heading panel-warning">
									<h2 class="panel-title"><?php echo iconoActividad('g')?> Outdoor</h2>
									<p class="panel-subtitle"><?php echo $inst ?></p>
								</header>
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							<section class="panel panel-danger">
								<header class="panel-heading">
									<h2 class="panel-title"><?php echo iconoActividad('e')?> Desk</h2>
									<p class="panel-subtitle"><?php echo $inst ?></p>
								</header>
								<div id="tabla_actividades_prioridad" class="panel-body">
									<table id="datatable-prioridades_"
						...
						<div class="col-md-4 col-sm-12 col-xs-12">
							...
							<section class="panel panel-warning">
								<header class="panel-heading">
									<h2 class="panel-title"><?php echo iconoActividad('l')?> Call</h2>
									<p class="panel-subtitle"><?php echo $inst ?></p>
								</header>
								<div id="tabla_actividades_prioridad" class="panel-body">
									<table id="datatable-prioridades_"
