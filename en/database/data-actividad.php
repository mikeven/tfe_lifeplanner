<?php
    ...
    function calcularFechasFuturas( $fecha, $frequencia, $n, $param ){
    	...
    	for ( $i = 0; $i < $n;  $i++ ){
    		...
    		if( $param == "impresion" ){
    			$dsemana = date( 'l', strtotime( $fecha ) );
    			$fechas[] = $dsemana . " " . date( 'Y-m-d', strtotime( $fecha ) );
    		}else{
	...
	if( isset( $_POST["mostrar_act"] ) ){ 
		...
		if( $actividad != NULL ){
			...
			$res["exito"] = -1;
			$res["mje"] = "There was a problem retrieving activity";
		}
		echo json_encode( $res );
	}
	/* --------------------------------------------------------- */	
	if( isset( $_POST["elim_act"] ) ){ 
		...
		if( $rsp != 0 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity deleted successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem deleting activity";
		}
	...
	if( isset( $_POST["prioridad"] ) ){ 
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity updated successfully";
		}else{
			$res["exito"] = -1;
	...
	if( isset( $_POST["agendar_act"] ) ){ 
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity moved to calendar successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem scheduling activity";
		}
	...
	if( isset( $_POST["nueva_fecha"] ) ){
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Date of activity updated successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem updating activity date";
		}
	...
	if( isset( $_POST["desagendar"] ) ){
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity removed successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem removing activity";
		}
	...
	if( isset( $_POST["finalizar_act"] ) ){
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity migrated to calendar successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem migrating activity";
		}
	...
	if( isset( $_POST["edit_rslt"] ) ){
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity successfully updated";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem updating activity";
		}
	...
	if( isset( $_POST["repetir_act"] ) ){
		...
		if( $rsp == 1 ){
			$res["exito"] = 1;
			$res["mje"] = "Activity was replicated successfully <a href='#!' onClick='window.location.reload()'>Reload</a>";
			$res["msg"] = "Activity was replicated successfully";
		}else{
			$res["exito"] = -1;
			$res["mje"] = "There was a problem replicating activity";
		}
